...
bool neu::CubemapTexture::Create(std::string filename, ...)
{
...
bool neu::CubemapTexture::Load(const std::vector<std::string>& filenames)
{
...
std::vector<std::string> neu::CubemapTexture::GenerateCubeMapNames(const std::string& basename, const std::string& extension)
{
