...
namespace neu
{
	...
	void CameraController::Update()
	{
		...
		if (g_inputSystem.GetKeyState(key_forward) == InputSystem::KeyState::Held)	direction.z += 1;
		if (g_inputSystem.GetKeyState(key_backward) == InputSystem::KeyState::Held)	direction.z -= 1;
